...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    private static final String MSG_GENERICA_USUARIO_FINAL = new StringBuilder()
            .append("Ocorreu um erro interno inesperado no sistema. ")
            .append("Tente novamente e se o problema persistir, entre em contato ")
            .append("com o administrador do sistema.").toString();
